/* GRAMMAR — Reports & Notices. Authoring format and rules are documented in
   ...
   weight), dates, times, and the colon before a list. Lists here are kept to
   two items on purpose — a three-item list invites the Oxford comma, and an
   Oxford-comma writer would be adding a comma to a CLEAN token and charged a
   false edit for being right. */
