...
export const CATEGORIES = [
  {
    ...
    compounds: [
      ...
      { name: 'hydrochloric acid', formula: 'HCl', common: 'muriatic acid', smiles: 'Cl' },
      { name: 'ammonia', formula: 'NH3', common: 'a pungent alkaline gas', smiles: 'N' },
      ...
      { name: 'water', formula: 'H2O', common: 'the universal solvent', smiles: 'O' },
    ],
  },
  {
    key: 'organic',
    label: 'Organic',
    compounds: [
      { name: 'methane', formula: 'CH4', common: 'marsh gas, the main natural gas', smiles: 'C' },
