...
export const SITE_PAGES = [
  ...
  { id: "base-blocks", title: "Manipulatives", href: "/prep-math/activity/base-blocks/index.html", category: "math", blurb: "3D blocks, abacuses and charts on one endless canvas.", keywords: ["manipulatives", "base blocks", "base ten blocks", "base 10 blocks", "dienes blocks", "place value", "number bases", "counting blocks", "abacus", "soroban", "suanpan", "schoty", "multiplication grid", "times table", "division grid", "place value chart"] },
