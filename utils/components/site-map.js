...
export const SITE_PAGES = [
  ...
  // ── Math & science activities ──────────────────────────────────────
  {
    ...
    category: "math",
    overview: true,
    blurb: "Hub of hands-on math activities: fractions, geometry (angles, transversals, Pythagoras, surface area) and Cartesian art.",
  ...
  { id: "pythagoras", title: "Pythagoras", href: "/prep-math/activity/pythagoras/index.html", category: "math", blurb: "Grow the squares on a right triangle, then break them apart to fill the one on the hypotenuse.", keywords: ["pythagoras", "pythagorean theorem", "right triangle", "hypotenuse", "a2 + b2 = c2", "geometry", "proof", "dissection"] },
  ...
  { id: "algebra-workbook", title: "Algebra Workbook", href: "/prep-math/activity/algebra-workbook/index.html", category: "math", blurb: "A printable algebra workbook: basic concepts — known and unknown, variables and constants, coefficients, and the words — then the polynomial remainder theorem with graphic organisers — a four-step frame, a swap ladder with a row per term, and a zero box — built for reinforcement and for learners who need the method drawn on the page.", keywords: ["algebra workbook", "variables", "constants", "coefficient", "known and unknown", "unknowns", "expressions", "basic algebra", "remainder theorem", "factor theorem", "polynomial", "polynomials", "substitution", "graphic organiser", "graphic organizer", "scaffold", "scaffolded worksheet", "special needs maths", "SEN maths", "reinforcement", "step by step", "worked example", "printable worksheet", "workbook generator", "worksheet generator", "print", "pdf", "answer key", "is it a factor", "find the remainder", "P(a)", "synthetic substitution", "algebra worksheet", "further maths", "homework sheet", "function machine", "function machines", "functions", "f(x)", "function notation", "input output", "find the rule", "inverse function", "working backwards", "mapping diagram", "is it a function", "composite function", "completing the square", "algebra tiles", "perfect square", "(x + a)^2", "quadratic", "solve quadratic", "sequences", "sequence", "nth term", "position to term", "term to term", "growing pattern", "patterns", "linear sequence", "is it in the sequence", "graphs of functions", "straight line graph", "linear graph", "plotting points", "coordinates", "table of values", "gradient", "intercept", "y = mx + c", "solving equations graphically", "simultaneous equations graph", "quadratic graph", "y = x squared", "properties", "identities", "balance scale", "bar model"] },
  { id: "sentence-studio", title: "Sentence Studio", href: "/writing/blocks/index.html", category: "english", blurb: "Build English writing out of blocks. Snap a subject, a verb and a phrase into a sentence; snap sentences into a paragraph with a topic sentence and supporting detail; snap paragraphs into a whole composition — narrative, descriptive, persuasive, expository, balanced report, recount, procedure or explanation. Parts of speech and figures of speech are blocks too, and the writing you build is written out beside the blocks as you go.", keywords: ["sentence studio", "writeblock", "writing blocks", "block writing", "sentence builder", "parts of speech", "figures of speech", "phrases", "clauses", "paragraph structure", "topic sentence", "composition", "narrative writing", "descriptive writing", "persuasive writing", "expository writing", "recount", "procedure", "explanation", "balanced report", "essay structure", "English writing", "learn to write", "visual writing tool"] },
  { id: "game-studio", title: "Game Studio", href: "/code/studio/index.html", category: "science", blurb: "Build a web page and a game out of blocks: HTML blocks for what is on the page, CSS blocks for how it looks, JavaScript blocks for what it does, and a Phaser extension for sprites, physics, input and effects. The code is written out beside the blocks as you build, and the preview runs it.", keywords: ["game studio", "webblock", "block coding", "visual programming", "learn to code", "HTML", "CSS", "JavaScript", "Phaser", "make a game", "game development for kids", "drag and drop coding", "blockly", "web page builder", "sprites", "physics", "animation", "coding for beginners", "code preview"] },
  { id: "js-workbook", title: "JavaScript Workbook", href: "/prep-math/activity/js-workbook/index.html", category: "math", blurb: "A JavaScript workbook for absolute beginners, with a code editor and a console on the page: read a program, say what it will print, then run it. Chapter one, data types: string, number and boolean, what quote marks change (7 + 7 is 14 but \"7\" + \"7\" is 77), typeof, writing your first console.log, null and undefined, mending \"2\" + 2 with Number(), and let and const. Programs run in a sandbox and are marked by what they print.", keywords: ["javascript workbook", "javascript", "js", "learn to code", "learn javascript", "coding for beginners", "programming workbook", "code editor", "console", "console.log", "data types", "typeof", "string", "number", "boolean", "null", "undefined", "variables", "let", "const", "type coercion", "Number()", "string concatenation", "printable coding worksheet", "programming exercises", "answer key"] },
  { id: "statistics-workbook", title: "Statistics Workbook", href: "/prep-math/activity/statistics-workbook/index.html", category: "math", blurb: "A printable statistics workbook: pictograms from simple to complex — sorting and counting, tally marks, reading a pictogram, keys and part symbols, building a pictogram (tapped into place on screen and marked), choosing a key, and pictogram problems; then bar charts, line graphs, pie charts and proportion, and scatter graphs with correlation and the line of best fit.", keywords: ["statistics workbook", "statistics", "data handling", "pictogram", "pictograph", "picture graph", "tally", "tally chart", "tally marks", "frequency", "key", "half symbol", "sorting", "counting", "data", "chart", "graph", "printable worksheet", "workbook generator", "worksheet generator", "answer key", "pdf", "bar chart", "bar graph", "line graph", "conversion graph", "pie chart", "pie charts", "angles in a pie chart", "percentages", "proportion", "direct proportion", "scatter graph", "scatter diagram", "correlation", "line of best fit", "outlier"] },
  { id: "geometry-workbook", title: "Geometry Workbook", href: "/prep-math/activity/geometry-workbook/index.html", category: "math", blurb: "A printable geometry workbook. Chapter one, polygon angles: measure a triangle with a protractor and tear its corners off to find 180°, cut polygons into triangles, the angle sum of any shape, each angle, exterior angles and word problems. Chapter two, transversal angles: parallel lines, vertically opposite, corresponding, alternate and consecutive angles, multiple transversals and triangles between parallels.", keywords: ["geometry workbook", "geometry worksheet", "printable worksheet", "worksheet generator", "print", "pdf", "answer key", "angles in a triangle", "angle sum of a triangle", "180 degrees", "triangle angles", "missing angle", "find the missing angle", "isosceles triangle", "right-angled triangle", "equilateral triangle", "protractor", "measuring angles", "tear the corners", "polygon angles", "interior angles", "sum of interior angles", "angles in a polygon", "(n-2) x 180", "decomposing polygons", "polygons into triangles", "diagonals", "regular polygon", "each interior angle", "exterior angle", "exterior angles", "exterior angle of a triangle", "sum of exterior angles", "360 degrees", "pentagon", "hexagon", "octagon", "quadrilateral", "angle word problems", "geometry word problems", "special needs maths", "SEN maths", "reinforcement", "homework sheet", "parallel lines", "transversal", "transversal angles", "angles on parallel lines", "vertically opposite angles", "vertical angles", "corresponding angles", "alternate angles", "alternate interior angles", "alternate exterior angles", "co-interior angles", "consecutive interior angles", "consecutive exterior angles", "same-side interior angles", "allied angles", "Z angles", "F angles", "C angles", "acute and obtuse angles", "multiple transversals", "triangle between parallel lines", "proof triangle 180", "pyramids and prisms", "prism", "pyramid", "faces edges vertices", "faces edges and corners", "euler formula", "nets of solids", "net of a cube", "surface area", "surface area of a prism", "surface area of a pyramid", "volume of a prism", "volume of a pyramid", "volume of a cuboid", "frustum", "cylinder cone sphere", "3d shapes", "solid shapes"] },
  { id: "maths-workbook", title: "Maths Workbook", href: "/prep-math/activity/maths-workbook/index.html", category: "math", blurb: "One printable maths workbook from six families — place value with base-ten blocks and charts, adding and taking away with and without regrouping written across and down, dividing by grouping objects with the divisor and remainder named, fractions to identify, colour and add, counting in fives into telling the time on a clock face, and angles with a protractor to cut out.", keywords: ["maths workbook", "printable worksheet", "worksheet generator", "workbook generator", "print", "pdf", "answer key", "place value", "base ten blocks", "dienes blocks", "place value chart", "expanded form", "numbers in words", "rounding", "comparing numbers", "addition", "subtraction", "adding", "taking away", "regrouping", "no regrouping", "carrying", "borrowing", "exchanging", "column addition", "column subtraction", "vertical addition", "horizontal addition", "division", "remainder", "divisor", "quotient", "grouping", "sharing", "division with remainders", "fractions", "identifying fractions", "colouring fractions", "coloring fractions", "equal parts", "fraction bars", "fraction strips", "fraction circles", "like fractions", "adding fractions", "subtracting fractions", "same denominator", "mixed number", "improper fraction", "counting in fives", "skip counting", "counting in 5s", "telling the time", "time", "clock", "clock face", "analogue clock", "o'clock", "half past", "quarter past", "quarter to", "minutes past", "reading a clock", "draw the hands", "angles", "protractor", "measuring angles", "acute", "obtuse", "right angle", "reflex", "straight angle", "printable protractor", "degrees", "special needs maths", "SEN maths", "reinforcement", "concrete pictorial abstract", "primary maths", "homework sheet"] },
  { id: "base-blocks", title: "Manipulatives", href: "/prep-math/activity/base-blocks/index.html", category: "math", blurb: "3D blocks, abacuses, algebra tiles, charts and written sums on one endless canvas.", keywords: ["manipulatives", "base blocks", "base ten blocks", "base 10 blocks", "dienes blocks", "place value", "number bases", "counting blocks", "abacus", "soroban", "suanpan", "schoty", "algebra tiles", "algebra cubes", "x squared", "zero pair", "negative tiles", "expand brackets", "factorise", "multiplication grid", "times table", "division grid", "place value chart", "long division", "bus stop method", "column addition", "vertical addition", "adding in columns", "carrying", "carry over", "written method", "number card"] },
  { id: "number-match", title: "Number Match", href: "/prep-math/activity/number-match/index.html", category: "math", blurb: "A board of numbers and a deck of sticky notes — the number in words, its places added together, how many tens and ones it has, tally marks and base-ten blocks — matched to the numeral they all mean.", keywords: ["number match", "matching activity", "matching game", "number forms", "representations of numbers", "standard form", "word form", "numbers in words", "expanded form", "expanded notation", "expanded addition", "place value", "tens and ones", "tally marks", "counting in fives", "base ten blocks", "dienes blocks", "number sense", "drag and drop", "tablet maths", "primary maths", "same value", "equivalent representations"] },
