...
export const SITE_PAGES = [
  ...
  { id: "remainder-theorem-workbook", title: "Polynomial Remainder Theorem", href: "/prep-math/activity/remainder-theorem-workbook/index.html", category: "math", blurb: "A printable remainder-theorem workbook with graphic organisers — a four-step frame, a swap ladder with a row per term, and a zero box — built for reinforcement and for learners who need the method drawn on the page.", keywords: ["remainder theorem", "factor theorem", "polynomial", "polynomials", "substitution", "graphic organiser", "graphic organizer", "scaffold", "scaffolded worksheet", "special needs maths", "SEN maths", "reinforcement", "step by step", "worked example", "printable worksheet", "workbook generator", "worksheet generator", "print", "pdf", "answer key", "is it a factor", "find the remainder", "P(a)", "synthetic substitution", "algebra worksheet", "further maths", "homework sheet"] },
