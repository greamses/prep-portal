...
export default {
  ...
  "media": {
    ...
    "hero": "photo-1456513080510-7bf3a84b82f8",
    "video": {
      "id": "M7lc1UVf-VE",
      "title": "Why grammar matters — in 3 minutes"
    }
  },
  "wordGroups": {
    "theyre": {
  ...
  "units": [
    {
      ...
      "keyVocab": [
        {
          "term": "contraction",
          "def": "two words joined with an apostrophe (they're = they are)"
        },
        {
          "term": "possessive",
          "def": "a word that shows ownership (their bags)"
        },
        {
          "term": "adverb of place",
          "def": "a word that points to a location (over there)"
        }
      ],
      "realWorld": {
    ...
    },
    {
      ...
      "keyVocab": [
        ...
        {
          "term": "past tense",
          "def": "an action that already happened (we were late)"
        },
        {
          "term": "question word",
          "def": "where asks about a place"
        }
      ],
      "realWorld": {
        "title": "Why it matters",
    ...
    },
    {
      ...
      "keyVocab": [
        {
          "term": "apostrophe",
          "def": "the mark ’ that stands in for missing letters"
        },
        {
          "term": "it's vs its",
          "def": "it's = it is/has · its = belonging to it"
        },
        {
          "term": "you're vs your",
          "def": "you're = you are · your = belonging to you"
        }
      ],
      "realWorld": {
        "title": "Why it matters",
    ...
    },
    {
      ...
      "keyVocab": [
        {
          "term": "preposition",
          "def": "to often shows direction (to school)"
        },
        {
          "term": "infinitive",
          "def": "to + verb (to run, to learn)"
        },
        {
          "term": "adverb",
          "def": "too can intensify (too hot) or add (me too)"
        }
      ],
      "realWorld": {
        "title": "Why it matters",
    ...
    },
    {
      ...
      "keyVocab": [
        {
          "term": "comparison",
          "def": "than weighs one thing against another (taller than)"
        },
        {
          "term": "sequence",
          "def": "then shows what comes next in time (first… then…)"
        }
      ],
      "realWorld": {
        "title": "Why it matters",
    ...
    },
    {
      ...
      "keyVocab": [
        {
          "term": "statement",
          "def": "a sentence that tells something — ends with a full stop"
        },
        {
          "term": "question",
          "def": "a sentence that asks something — ends with a question mark"
        }
      ],
      "realWorld": {
        "title": "Why it matters",
      ...
      "exercise": {
        ...
        "items": [
          ...
          [
            "We ate rice and stew for lunch",
            {
              "correct": "."
            }
          ],
          ...
          [
            "The market was very busy today",
            {
              "correct": "."
            }
          ]
    ...
    },
    {
      ...
      "keyVocab": [
        {
          "term": "list",
          "def": "three or more items separated by commas"
        },
        {
          "term": "opening phrase",
          "def": "an introduction at the start of a sentence (After school, …)"
        }
      ],
      "realWorld": {
        "title": "Why it matters",
    ...
    },
    {
      ...
      "keyVocab": [
        {
          "term": "end mark",
          "def": "the . or ? that closes a sentence"
        },
        {
          "term": "internal punctuation",
          "def": "marks like , that sit inside a sentence"
        }
      ],
      "realWorld": {
        "title": "Why it matters",
    ...
    },
    {
      ...
      "keyVocab": [
        {
          "term": "contraction",
          "def": "do not → don't · it is → it's"
        },
        {
          "term": "possession",
          "def": "the boy's bag = the bag of the boy"
        }
      ],
      "realWorld": {
        "title": "Why it matters",
