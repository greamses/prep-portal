/* ============================================================================
   ...
   dynamically imports the game once BABYLON exists on window. The drone and pads
   are procedural, so no glTF loader is needed. Falls back to a plain <script>
   tag if streaming isn't possible (CORS/CSP).
   ========================================================================== */
