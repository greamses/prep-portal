...
{
"question": "For the reaction \\( NH*3(g) + HCl(g) \\rightarrow NH_4Cl(g) \\), an increase in pressure will",
"image": null,
"options": [
...
{
"question": "Carbohydrates can generally be represented by the general formula \\( C*x(H_2O)\_y \\), for fructose the value for 'X' is",
"image": null,
"options": [
"3",
"12",
...
"explanation": [
"Fructose is a monosaccharide with six carbon atoms, giving it the molecular formula \\( C_6H*{12}O*6 \\).",
...
{
"question": "The empirical mass of \\( C_6H*{12}O*6 \\) is (where H = 1, C = 12, O = 16)",
"image": null,
"options": [
"90",
"180",
...
"explanation": [
"The molecular formula \\( C_6H*{12}O_6 \\) can be simplified by dividing all subscripts by 6, giving the empirical formula \\( CH_2O \\).",
