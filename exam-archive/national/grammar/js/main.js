...
function renderBreakdown() {
  ...
  title.className = 'pp-breakdown-title';
  ...
  cats.forEach((c, i) => {
    ...
    cell.className = `pp-sticky pp-sticky--tape pp-bd-cell ${stickyColor(i)}`;
    cell.innerHTML = `
      <span class="pp-bd-key">${c.key}</span>
      <span class="pp-bd-label">${c.short}</span>
      <span class="pp-bd-score">${stat.caught}/${stat.total}</span>
      <span class="pp-bd-tag">${stat.tagged} named</span>`;
  ...
  if (falseEdits) {
    ...
    note.className = 'pp-breakdown-note';
