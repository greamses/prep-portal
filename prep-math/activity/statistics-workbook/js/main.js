...
mountBuilder({
  ...
  glyphs: {
    ...
    "ln-intro": ICON.lnIntro,
    "ln-read": ICON.lnRead,
    "ln-between": ICON.lnBetween,
    "ln-draw": ICON.lnDraw,
    "ln-trend": ICON.lnTrend,
    "ln-solve": ICON.lnSolve,
    "pi-whole": ICON.piWhole,
    "pi-read": ICON.piRead,
    "pi-angles": ICON.piAngles,
    "pi-draw": ICON.piDraw,
    "pi-prop": ICON.piProp,
    "sc-plot": ICON.scPlot,
    "sc-read": ICON.scRead,
    "sc-corr": ICON.scCorr,
    "sc-fit": ICON.scFit,
    "sc-solve": ICON.scSolve,
    "pb-words": ICON.pbWords,
    "pb-die": ICON.pbDie,
    "pb-roll": ICON.pbRoll,
