...
mountBuilder({
  ...
  glyphs: {
    ...
    "py-right": ICON.rightTri,
    "py-sides": ICON.hyp,
    "py-squares": ICON.pySquares,
    "py-sum": ICON.pySum,
    "py-diff": ICON.pyDiff,
    ...
    "tf-describe": ICON.tfDescribe,
    "ci-parts": ICON.ciParts,
    "ci-iso": ICON.ciIso,
    "ci-centre": ICON.ciCentre,
    "ci-semi": ICON.ciSemi,
    "ci-same": ICON.ciSame,
    "ci-cyclic": ICON.ciCyclic,
    "ci-tangent": ICON.ciTangent,
    "ci-chord": ICON.ciChord,
    "ci-alt": ICON.ciAlt,
    "ci-reason": ICON.ciReason,
    "la-paths": ICON.laPaths,
    "la-name": ICON.laName,
    "la-kinds": ICON.laKinds,
    "la-line": ICON.laLine,
    "la-point": ICON.laPoint,
    "la-vo": ICON.laVo,
    "la-comp": ICON.laComp,
    "la-perp": ICON.laPerp,
    "la-algebra": ICON.laAlgebra,
    "la-reason": ICON.laReason,
    "ar-kinds": ICON.arKinds,
    "ar-perim": ICON.arPerim,
    "ar-area": ICON.arArea,
    "ar-ratio": ICON.arRatio,
    "ar-py": ICON.arPy,
    "ar-comp": ICON.arComp,
    "pr-sides": ICON.prSides,
    "pr-angles": ICON.prAngles,
    "pr-heights": ICON.prHeights,
    "pr-diags": ICON.prDiags,
    "pr-sym": ICON.prSym,
    "pr-all": ICON.prAll,
    "pc-centre": ICON.pcCentre,
