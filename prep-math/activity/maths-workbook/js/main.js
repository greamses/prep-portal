...
mountBuilder({
  ...
  glyphs: {
    ...
    "frac-what": ICON.pie,
    "frac-add": ICON.frac,
    "frac-equal": ICON.equal,
    "frac-convert": ICON.mixed,
    "frac-unlike": ICON.cut,
    fives: ICON.fives,
    time: ICON.clock,
    "mul-groups": ICON.ring,
    "mul-arrays": ICON.array,
    "mul-facts": ICON.times,
    "mul-blocks": ICON.blocks,
    "mul-grid": ICON.table,
    "mul-column": ICON.times,
    "mul-lattice": ICON.lattice,
    "mul-words": ICON.sentence,
  },
  icons: ICON,
